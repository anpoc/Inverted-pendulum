...
\Figure[t!][scale=0.5]{pendulo.PNG}{diagrama.\label{diagram}}
...
\Figure[t!][scale=0.5]{diagrama_cuerpo.PNG}{diagrama.\label{cuerpo}}
...
\Figure[t!][scale=1]{diagrama_bloques.PNG}
{diagrama de bloques.\label{diagramabloques}}

\Figure[t!][scale=0.6]{diagrama_bloques_subsistema.PNG}
...
\Figure[t!][scale=0.2]{figures/var/m/m.png}
       {Respuesta temporal del modelo, ante cambios en el parametro
